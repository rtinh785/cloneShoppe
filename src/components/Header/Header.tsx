    ...
    <div className='pb-5 pt-2 bg-[linear-gradient(-180deg,#f53d2d,#f63)] text-white'>
      <div className='my-container'>
        <div className='flex justify-end'>
          <Popover
            ...
            renderPopover={
              <>
                <ul className='pr-5'>
                  <li>
                    <button className='py-2 px-3 hover:text-orange-200'>Tiếng Việt</button>
                  </li>
                  <li>
                    <button className='py-2 px-3 hover:text-orange-200'>Tiếng Anh</button>
                  </li>
                </ul>
              </>
            }
          ...
          {isAuthenticated ? (
            <Popover
              className='flex justify-center items-center py-1 hover:text-gray-300 cursor-pointer ml-6'
              renderPopover={
                <>
                  <ul>
                    <li>
                      <Link to='/' className='py-2 px-3 hover:text-cyan-500 block'>
                        Tài khoản của tôi
                      </Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <button
                        className='py-2 px-3 hover:text-cyan-500 block'
                        onClick={() => {
            ...
            <div className='flex items-center'>
              ...
              <div className='border-r border-r-white/40 h-4'></div>
        ...
        <div className='grid grid-cols-12 gap-4 mt-4 items-end'>
          ...
          <form className='col-span-9'>
            <div className='bg-white rounded-sm p-1 flex  '>
              ...
              />
              <button className='rounded-sm py-2 px-6 shrink-0 bg-orange-600 hover:opacity-90'>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  fill='none'
                  viewBox='0 0 24 24'
          ...
          <div className='col-span-1  '>
            {/* gio hang` */}
            <Popover
              className='flex items-center py-1 hover:text-gray-300 cursor-pointer ml-6  translate-x-[-36%]'
              renderPopover={
                <>
                  <div className='max-w-[400px] text-sm'>
                    <div className='p-2'>
                      <div className='text-gray-400 captitalize'>Sản phẩm mới thêm</div>
                      {/* List */}
                      <div className='mt-5'>
                      ...
                      <div className='flex mt-8 items-center justify-between'>
                        ...
                        <button className='capitalize bg-orange-500 hover:opacity-80 px-4 py-2 rounded-sm text-white'>
                          Xem giỏ hàng
                        </button>
                      </div>
                    </div>
