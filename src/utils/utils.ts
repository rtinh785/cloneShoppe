...
export function isAxiosExpiredTokenRerror<UnauthorizedError>(error: unknown): error is AxiosError<UnauthorizedError> {
  return (
    isAxiosUnauthorizedError<ErroResponse<{ name: string; message: string }>>(error) &&
